...
<template>
  <div class="user-page art-full-height">
    ...
    <Search
      ...
      :formItems="formItems"
      :defaultValue="DEFAULT_TENANT_SEARCH"
...
<script setup lang="ts">
  ...
  import { DEFAULT_TENANT_SEARCH } from './modules/form.config'
  ...
  // 搜索表单数据
  const searchFormData = ref({ ...DEFAULT_TENANT_SEARCH })
  const formItems = ref([
    {
      label: '套餐名称',
      prop: 'packageName',
